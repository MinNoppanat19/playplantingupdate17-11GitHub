                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if($cartitems->count() > 0)
                                ...
                                <h6 class="px-2">Grand Total  <span class="float-end"> {{ $total }} Baht </span></h6>
                                <hr>
...
@section('scripts')
    ...
    <script src='https://www.paypal.com/sdk/js?client-id=AfmcjLvp3ACKfA98t4g_LvgL51MPCl2uGfW1TjSt0cKw49ewWjWPQQ89pAa25a8urv__-B1WdV8KeOF0'> </script>
