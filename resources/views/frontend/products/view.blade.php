                ...
                <div class="col-md-8">
                    <h2 class="mb-0">
                        ...
                        @if($products->trending == '1')
                            <label style="font-size: 16px;" class="float-end badge bg-danger trending_tag"> Recommended </label>
                        @endif
                    </h2>
                    <hr>
                    <label class="me-3">Original Price : <s> {{ $products->original_price }} Baht</s></label>
                    <label class="fw-bold">Selling Price : {{ $products->selling_price }} Baht </label>
